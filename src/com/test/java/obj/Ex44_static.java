...
public class Ex44_static {
	...
	public static void main(String[] args) {
		...
		Student.setSchool("역삼중학교"); //정적 변수> 공용데이터(***)
		
		Student s1 = new Student();
		s1.setName("홍길동");//객체변수 > 개인 데이터(***)
		s1.setAge(15); 
...
//		System.out.println(result);
		...
		//Math math2 = new Math(); > X > Static 제공되는 경우가 많다
...
public static void setSchool(String school) {
	...
	public static void bbb() {
		...
		//-집합과 관련된 작업 > 가능 
		System.out.println(Student.school); //정적 변수
		//System.out.println(this.name); //정적메소드안에서 개체변수에 접근 할 수 없다
		Student.setSchool("역삼중학교"); // 정적 메소드
