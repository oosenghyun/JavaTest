...
public class Ex36_Class {
	public static void main(String[] args) {
		...
		/*
		 ...
		 5.인터페이스
		 -캡슐화된 내부와 외부간이 최소한의 연결이 가능한 통로 역할
		 ex) 게임 인터페이스
		...
		//-배열 단점 > 요소간의 성질을 구분하기 힘들다. > 첨자 사용> 첨자는 의미를 가지지 못한다 > 몇번째 방에 어떤 데이터를 넣었는지  관리 힘들다
		...
		//-멤버 변수의 이름 존재 >x , y>배열과 달리 멤버의 의미 명확
		//클래스명 변수명 = new 생성자();
