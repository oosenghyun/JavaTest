...
public class Ex15_Operator {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  연산자 연산 방향
		  -하나의 문장에 속해있는 연산자들 중 우선 순위 동일하면 누가 먼저 실행해야하는지에 대한 규칙
		  -대부분: 왼쪽 > 오른쪽
		  -1 + 2 + 3
		...
		System.out.println(10 / 3);       //정수/실수 =3
		...
		System.out.println(10 / 3.0);     //정수/실수 =3.333333333
 		...
 		//***모든 산술 연산자의 결과 자료형은 
 		//   두 피연사자의 자료형 중 더 크기가 큰 자료형으로 반환된다.
 		...
 		System.out.println(e + f); // 30억 > -1294967296 //int로만 반환되므로 
 		...
 		//***위와 같은 이유> 정수 사용 > byte 와 short를 거의 사용 안함
 		//   정수> 주로 int 사용
